            ...
            <div className="flex flex-col w-5/6 justify-center text-center">
              <div className="flex flex-col text-white w-full h-full justify-center">
                ...
                <div className="flex justify-center">
                  <p className="text-md tracking-wide w-full md:w-3/4 lg:w-1/2 text-neutral-200 leading-relaxed">
                    Go and show them how strong you are. Leave them with their
                    jaws to the ground, and hit them so that they faint on the
                    ropes. Since you've got talent, you have to wear a crown.
                  </p>
                </div>
                {/* <div>
