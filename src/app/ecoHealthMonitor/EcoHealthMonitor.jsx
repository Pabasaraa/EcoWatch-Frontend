...
const EcoHealthMonitor = () => {
  ...
  useEffect(() => {
    taskId &&
      navigate(`${routerPaths.ECOHEALTH_PREDICTION_RESULT}/${taskId}`);
  ...
  const onProceed = async (input) => {
    ...
    await axios
      .post(`${BACKEND_END_POINT}/ecohealth/predict`, formData)
      .then((response) => {
...
export default EcoHealthMonitor;
