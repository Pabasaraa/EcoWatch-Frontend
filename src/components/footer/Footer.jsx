  ...
  return (
    <footer className="bg-gray-800 text-white py-6 px-4">
      ...
      <div className="flex justify-center items-center">
        <div className="flex w-full md:w-3/4 lg:w-1/2 justify-between">
          <div className="text-xl text-green-500 font-semibold cursor-pointer">
            EcoWatch
          </div>
          <div className="flex space-x-4 items-center">
            <a
              href="https://github.com/Pabasaraa/Ecohub-Webapp"
              target="_blank"
              rel="noopener noreferrer"
              className="text-neutral-300 font-xs hover:text-green-500"
            >
              Support
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-neutral-300 hover:text-green-500"
            >
              Contact Us
            </a>
            <a
